                ...
                <div className="p-8 overflow-y-auto max-h-[70vh] space-y-8">
                    ...
                    <section>
                        ...
                        <ul className="mt-2 space-y-1 ml-6 list-disc text-slate-400 text-sm">
                            <li><span className="text-slate-200">Outpainting:</span> {t('guideSection1Item1')}</li>
                            <li><span className="text-slate-200">Upscaling:</span> {t('guideSection1Item2')}</li>
                            <li><span className="text-slate-200">Composition Correction:</span> {t('guideSection1Item3')}</li>
                        </ul>
                    </section>
                    ...
                    <section>
                        ...
                        <p className="text-slate-400 text-sm leading-relaxed mb-2">
                            {t('guideSection2Desc1')}
                        </p>
                        <p className="text-slate-400 text-sm leading-relaxed">
                            {t('guideSection2Desc2')}
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="bg-slate-900/50 p-4 rounded-xl border border-slate-800">
                                <span className="text-xs font-bold text-emerald-400 uppercase">{t('guideAspectRatio')}</span>
                                <p className="text-slate-400 text-xs mt-1">
                                    {t('guideAspectRatioDesc')}
                                </p>
                            </div>
                            <div className="bg-slate-900/50 p-4 rounded-xl border border-slate-800">
                                <span className="text-xs font-bold text-emerald-400 uppercase">{t('guideResolution')}</span>
                                <p className="text-slate-400 text-xs mt-1">
                                    {t('guideResolutionDesc')}
                                </p>
                            </div>
                        </div>
                    </section>
